...
public class ColecaoController extends AnchorPane {
    ...
    public ColecaoController() {
        try {
            FXMLLoader fxml = new FXMLLoader(getClass().getResource("/fxml/colecao.fxml"));
    ...
    void excluir(ActionEvent event) {
        try {
            ...
            if (response == Dialogo.Resposta.YES) {
                new ColecaoDAO().excluir(colecao.getId());
                sincronizarBase();
                tabela();
            }
    ...
    private void sincronizarBase() {
        listaColecao = new ColecaoDAO().listar();
    }
