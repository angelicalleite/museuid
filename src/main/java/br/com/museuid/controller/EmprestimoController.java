...
import br.com.museuid.banco.dao.InstituicaoDAO;
...
public class EmprestimoController extends AnchorPane {
    ...
    public EmprestimoController() {
        try {
            FXMLLoader fxml = new FXMLLoader(getClass().getResource("/fxml/emprestimo.fxml"));
    ...
    void salvar(ActionEvent event) {
        ...
        } else if (emprestimoDAO.isEmprestimo(numEmprestimo, idEmprestimo)) {
    ...
    void excluir(ActionEvent event) {
        try {
            ...
            if (response == Dialogo.Resposta.YES) {
                new EmprestimoDAO().excluir(emprestimo.getId());
                sincronizarBase();
                tabela();
            }
    ...
    private void sincronizarBase() {
        listaEmprestimo = new EmprestimoDAO().listar();
    }
     ...
     */
    public void combos() {
        Combo.popular(cbInstituicao, new InstituicaoDAO().combo());
