...
public class UsuarioController extends AnchorPane {
    ...
    public UsuarioController() {
        try {
            FXMLLoader fxml = new FXMLLoader(getClass().getResource("/fxml/usuario.fxml"));
    ...
    void salvar(ActionEvent event) {
        ...
        } else if (usuarioDAO.isUsuario(idUsuario, login)) {
    ...
    private void combos() {
        ...
        Combo.popular(cbPermissaoUsuario, usuarioDAO.usuariosTipo());
    }
