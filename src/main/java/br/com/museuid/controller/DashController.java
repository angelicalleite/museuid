...
public class DashController extends AnchorPane {
    ...
    public DashController() {
        try {
            FXMLLoader fxml = new FXMLLoader(getClass().getResource("/fxml/dash.fxml"));
    ...
    private void baseDados() {
        ...
        designacoes = catalogacaoDAO.designacoes();
        estratigrafias = catalogacaoDAO.estratigrafias();
        colecoes = catalogacaoDAO.colecoes();
        recentes = catalogacaoDAO.recentes();
        excursao = excursaoDAO.acompanhamento(Tempo.atual());
        emprestimo = emprestimoDAO.acompanhamento();
    }

    private void contagem() {
        lbTotalColecoes.setText("" + new ColecaoDAO().total());
        lbTotalDesignacao.setText("" + new DesignacaoDAO().total());
        lbTotalEstratigrafias.setText("" + new EstratigrafiaDAO().total());
    }
    ...
    private void totalCatalogacao() {
        lbTotalCatalogacoes.setText("" + new CatalogacaoDAO().total());
    }
    ...
    private void totalVisitantes() {
        lbTotalVisitantes.setText("" + new VisitanteDAO().total());
    }
