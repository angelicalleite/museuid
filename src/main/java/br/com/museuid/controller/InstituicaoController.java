...
public class InstituicaoController extends AnchorPane {
    ...
    public InstituicaoController() {
        try {
            FXMLLoader fxml = new FXMLLoader(getClass().getResource("../../../../../resources/fxml/instituicao.fxml"));
    ...
    void salvar(ActionEvent event) {
        ...
        if (vazio) {
            ...
            if (idInstituicao == 0) {
                new InstituicaoDAO().inserir(instituicao);
                Mensagem.info("Instituição cadastrado com sucesso!");
            } else {
                new InstituicaoDAO().editar(instituicao);
    ...
    void excluir(ActionEvent event) {
        try {
            ...
            if (response == Dialogo.Resposta.YES) {
                new InstituicaoDAO().excluir(instituicao.getId());
                sincronizarBase();
                tabela();
            }
    ...
    private void sincronizarBase() {
        listaInstituicoes = new InstituicaoDAO().combo();
    }
