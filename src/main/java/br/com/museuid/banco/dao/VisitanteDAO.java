...
public class VisitanteDAO  {
    ...
    public void editar(Visitante visitante) {
        new ModelDAO<Visitante>().update(visitante);
        /*
        try {
    ...
    public void excluir(int idVisitante) {
        new ModelDAO<Visitante>().delete(new Visitante(idVisitante));
        /*
        try {
    ...
    public List<Visitante> listar() {
        ModelDAO modelDAO = new ModelDAO<Visitante>();

        String sql = " FROM Visitante ";

        List<Visitante> visitantes = (List) modelDAO.findSQL(sql);
