...
public class SetorDAO {
    ...
    public void editar(Setor setor) {
        new ModelDAO<Setor>().update(setor);
        /*
        try {
    ...
    public void excluir(int idSetor) {
        new ModelDAO<Setor>().delete(new Setor(idSetor));
        /*
        try {
    ...
    public List<Setor> listar() {
        ModelDAO modelDAO = new ModelDAO<Setor>();

        String sql = " FROM Setor s, Organizacao o WHERE  s.orgao.id = o.id ";

        List<Setor> setors = (List) modelDAO.findSQL(sql);
    ...
    public List<Setor> combo(int organizacao) {
        ...
        String sql = " FROM Setor WHERE s.orgao.id = "+organizacao+" ORDER BY s.nome ";
    ...
    public List<Setor> combo() {
        ...
        String sql = " FROM Setor s ORDER BY s.nome ";
