...
public class ExcursaoDAO  {
    ...
    public void editar(Excursao excursao) {
        new ModelDAO<Excursao>().update(excursao);
        /*
        try {
    ...
    public void excluir(int idExcursao) {
        new ModelDAO<Excursao>().delete(new Excursao(idExcursao));
        /*
        try {
    ...
    public List<Excursao> listar() {
        ...
        String sql = " FROM Excursao e, Instituicao i " +
                " WHERE e.instituicao.id = i.instituicao.id ";

        List<Excursao> excursaos = (List<Excursao>) modelDAO.findSQL(sql);
    ...
    public List<Excursao> acompanhamento(Timestamp data) {
        ...
        String sql = " FROM tb_excursao AS e, tb_instituicao AS i "
