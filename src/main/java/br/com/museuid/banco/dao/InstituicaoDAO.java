...
public class InstituicaoDAO  {
    ...
    public void editar(Instituicao instituicao) {
        new ModelDAO<Instituicao>().update(instituicao);
        /*
        try {
    ...
    public void excluir(int idInstituicao) {
        new ModelDAO<Instituicao>().delete(new Instituicao(idInstituicao));
        /*
        try {
    ...
    public List<Instituicao> listar() {
        ModelDAO modelDAO = new ModelDAO<Instituicao>();

        List<Instituicao> colecaos = (List<Instituicao>) modelDAO.lists(new Instituicao());
    ...
    public List<Instituicao> combo() {
        ...
        String sql = " FROM Instituicao i ORDER BY i.nome";

        List<Instituicao> catalogacaos = (List) modelDAO.findSQL(sql);
    ...
    public boolean isInstituicao(String instituicao) {
        ...
        List<Instituicao> catalogacaos = (List) modelDAO.lists(new Instituicao());
