...
public class OrganizacaoDAO  {
    ...
    public void editar(Organizacao organizacao) {
        new ModelDAO<Organizacao>().update(organizacao);
        /*
        try {
    ...
    public void excluir(int idOrganizacao) {
        new ModelDAO<Organizacao>().delete(new Organizacao(idOrganizacao));
        /*
        try {
    ...
    public List<Organizacao> listar() {
        ModelDAO modelDAO = new ModelDAO<Excursao>();

        List<Organizacao> organizacaos = (List) modelDAO.lists(new Organizacao());
    ...
    public List<Organizacao> combo() {
        ModelDAO modelDAO = new ModelDAO<Organizacao>();

        String sql = " FROM Organizacao o ORDER BY o.nome";

        List<Organizacao> organizacaos = (List) modelDAO.findSQL(sql);
