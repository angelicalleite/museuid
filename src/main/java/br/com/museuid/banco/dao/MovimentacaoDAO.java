...
public class MovimentacaoDAO {
    ...
    public void editar(Movimentacao movimentacao) {
        new ModelDAO<Movimentacao>().update(movimentacao);
        /*
        try {
    ...
    public void excluir(int idMovimentacao) {
        new ModelDAO<Movimentacao>().delete(new Movimentacao(idMovimentacao));
        /*
        try {
    ...
    public List<Movimentacao> listar() {
        ModelDAO modelDAO = new ModelDAO<Movimentacao>();

        List<Movimentacao> movimentacaos = (List) modelDAO.lists(new Movimentacao());
